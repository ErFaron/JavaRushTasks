...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            if(loadedObject.equals(classWithStatic)){classWithStatic = loadedObject;}
    ...
    public static class ClassWithStatic {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            while (printReader.ready()){
                this.staticString = printReader.readLine();
                this.i = Integer.parseInt(printReader.readLine());
                this.j = Integer.parseInt(printReader.readLine());
            }
            //implement this method - реализуйте этот метод
        }
